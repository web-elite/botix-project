...
class TestPlanMenu extends InlineMenu
{
    ...
    public function start(Nutgram $bot)
    {
        $this->clearButtons();
        // $bot->sendMessage(
        //         text: "🔃 درحال حاضر امکان دریافت اشتراک تست وجود ندارد!... \n📢 آدرس کانال دریچه: " . env('TELEGRAM_BOT_ADMIN_CHANNEL') . "\n آدرس پشتیبانی: @Dariche_vpn_admin\n\n در صورت باز شدن حتما از طریق کانال اطلاع رسانی خواهیم کرد."
        //     );
        //     return;
    ...
    {
        $userXuiSubs = app(UserService::class)->getUserXuiData($bot->chatId(), 'test');
